"""
    ----------------------------------------
    AIMI nnU-Net Thoracic OAR - post-processing utils
    ----------------------------------------
...
def pypla_nifti_to_nrrd(pred_nifti_path, processed_nrrd_path,
  ...
  pred_nrrd_path = os.path.join(processed_nrrd_path, pat_id, pat_id + "_pred_thoracic_oar.nrrd")
...
def numpy_to_nrrd(model_output_folder, processed_nrrd_path, pat_id,
  ...
  Arguments:
    ...
    structure_list      : optional - list of the structures whose probability maps are stored in the 
                                     ...
                                     list for the thoracic OAR model (background = 0 included).
  Outputs:
    This function [...]
  """
...
def nifti_to_dicomseg(sorted_base_path, processed_base_path,
  ...
  pred_segmasks_nifti = os.path.join(processed_nifti_path, pat_id, pat_id + "_pred_thoracic_oar.nii.gz")
